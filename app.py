...
def image():
    if request.method == 'POST':
        ...
        if allowed_file(fileName):
            ...
            IMG_SIZE = 50
            LR = 1e-3
            MODEL_NAME = 'glaucoma-{}-{}.model'.format(LR, '2conv-basic')
        ##    MODEL_NAME='keras_model.h5'
            ...
            if os.path.exists('{}.meta'.format(MODEL_NAME)):
                ...
                for num, data in enumerate(verify_data):
                    ...
                    if np.argmax(model_out) == 0:
                        str_label = "stage1"
                        rem = "The remedies for Stage1 glaucoma are:\n\n "
                        ...
                        dic={'stage1':A,'stage2':B,'glaucoma':C,'Normal':D}
                        algm = list(dic.keys()) 
                        ...
                        plt.title("Accuracy Comparision between Glaucoma detection...")
                        ...
                        str_label = "stage2"
                        rem = "The remedies for Stage2 glaucoma are: "
                        ...
                        str_label = "Glaucoma"
                        rem = "The remedies for Glaucoma detection are: "
            ...
            return render_template('userlog.html', status=str_label,accuracy=accuracy,remedie=rem, remedie1=rem1,ImageDisplay="http://127.0.0.1:5000/static/images/"+fileName,ImageDisplay1="http://127.0.0.1:5000/static/matrix.png")
        else:
            return render_template("userlog1.html",status="Invalid File Format")
